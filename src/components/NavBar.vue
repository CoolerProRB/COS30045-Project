<template>
    <nav class="bg-white dark:bg-gray-900 flex h-14 sticky top-0 px-10 border-b border-gray-200 dark:border-gray-800">
        <div class="flex items-center w-full justify-between lg:px-0">
            ...
            <div class="md:hidden">
                <button id="mobile-menu-button" class="text-gray-800 dark:text-gray-100 focus:outline-none" @click="toggleMenu()">
    ...
    <div id="mobileNav" class="items-center sticky top-14 hidden md:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="py-3 px-10 border-b border-gray-200 dark:border-gray-700">
            <label class="theme-switch">
                <input type="checkbox" class="theme-switch__checkbox" @click="toggleTheme" :checked="theme === 'dark'">
                <div class="theme-switch__container">
                    <div class="theme-switch__clouds"></div>
